...
class HistorySearch extends Component {
  ...
  deleteHistoryItem = id => {
    ...
    const remainingSearchHistory = searchHistory.filter(each => each.id !== id)
    this.setState({searchHistory: remainingSearchHistory})
  }

  render() {
    const {searchInput, searchHistory} = this.state
    const filteredHistoryList = searchHistory.filter(each =>
